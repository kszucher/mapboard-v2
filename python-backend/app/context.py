...
class UnitOfWork:
    def __init__(self, session: AsyncSession, broker: GraphEventBroker, sender_client_id: Optional[str] = None):
        ...
        self._nodes: Optional[NodeRepository] = None
        self._edges: Optional[EdgeRepository] = None
        self._expressions: Optional[ExpressionRepository] = None
        self._graphs: Optional[GraphRepository] = None
