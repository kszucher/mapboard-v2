import { DotsHorizontalIcon, PlusIcon, MinusIcon, ArrowUpIcon, ArrowDownIcon, TrashIcon } from '@radix-ui/react-icons'
        ...
        {hasConnectedNode ? (
          ...
          <DropdownMenu.Sub>
            ...
            <DropdownMenu.SubContent>
              ...
              <DropdownMenu.Item onClick={() => handleAddConnectedNode('LOGICAL_SWITCH')}>{'Logical Switch'}</DropdownMenu.Item>
              <DropdownMenu.Item onClick={() => handleAddConnectedNode('AGENTIC_SWITCH')}>{'Agentic Switch'}</DropdownMenu.Item>
            </DropdownMenu.SubContent>
          </DropdownMenu.Sub>
        )}
